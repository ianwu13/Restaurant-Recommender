...
cc = surprise.prediction_algorithms.co_clustering.CoClustering(n_cltr_u=5, n_cltr_i=5)
cc.fit(dataset)
...
with open(out_file, 'w') as f:
    ...
    while line != '':
        sploot = line[:-1].split(',')
        res = cc.predict(sploot[0], sploot[1])
...
/opt/spark/spark-3.1.2-bin-hadoop3.2/bin/spark-submit --executor-memory 4G --driver-memory 4G test.py ../resource/asnlib/publicdata/ ../resource/asnlib/publicdata/yelp_val.csv ./test.txt
'''
